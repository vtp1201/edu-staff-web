// Brand glyphs for SSO providers. Decorative — callers label the button text;
// these carry aria-hidden. Fixed brand colours per each provider's guidelines
// (brand marks are exempt from the design-token palette).
...
export function VneidIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="18"
