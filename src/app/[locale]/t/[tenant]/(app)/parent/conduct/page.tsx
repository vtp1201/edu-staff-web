...
// Mock child id — in production this comes from the parent's selected child (mock-first).
const MOCK_STUDENT_ID = "s-1";

export default async function ParentConductPage() {
  ...
  return (
    <StudentConductScreen
      viewerRole="parent"
      childName={conductSummary?.studentName}
      childClass={conductSummary?.className}
