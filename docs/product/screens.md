...
| Courses + lesson player | `(app)/student/courses`,`/courses/[courseId]` | `features/lms` | ✅ US-E11.6 (grid+tabs, 2-col player, video/pdf/text, notes/Q&A, mark-complete; mock-first — BE force-mock bất kể `USE_MOCK`, US-E18.60/ADR 0073, chờ ask #51) — ⚠️ superseded by the course_items redesign: US-E24.2 (course cards v2) + US-E24.3 (single vertical timeline) replace the grid+tabs/chapter-list player; US-E24.5 moves the player to `/courses/[courseId]/items/[itemId]` |
| Assignments | `(app)/student/assignments` | `features/lms` | ✅ US-E11.7 (mock-first — lms service scaffold; BE force-mock bất kể `USE_MOCK`, US-E18.60/ADR 0073, chờ ask #51) — ⚠️ US-E24.4 merges this into the unified "Khoá học" cross-cutting tab (`/student/courses?view=assignment`); this sidebar route becomes a permanent redirect (Q-C). Route/status unchanged until E24.4 lands |
