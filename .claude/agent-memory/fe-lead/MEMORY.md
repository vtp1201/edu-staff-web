...
- [E12 Admin Core epic](project-e12-admin-core.md) — US-E12.1 + US-E12.8 implemented; US-E12.2 implemented; US-E12.5 timetable-builder implemented (mock-first); remaining US-E12.3..E12.6 planned
- [E06 BE Integration epic](project-e06-be-integration.md) — US-E06.3 Kong base URL done; US-E06.4 IAM member/invitation repo done; US-E06.5 core school+calendar repo done; E06.6..E06.8 planned
