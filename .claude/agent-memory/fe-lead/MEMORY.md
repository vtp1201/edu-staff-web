...
- [E17 UX polish epic](project-e17-ux-polish.md) — US-E17.2/E17.3/E17.4/E17.5 implemented (DR-010); US-E17.4 extracted components/shared/empty-state/; verify design-spec.jsonc token literals against real contrast; blocks US-E17.7
