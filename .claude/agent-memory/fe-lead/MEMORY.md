...
- [E17 UX polish epic](project-e17-ux-polish.md) — US-E17.1/E17.2/E17.3/E17.4/E17.5/E17.6/E17.7 implemented (DR-010); `bun run build` not bare `bun build`; QA real-browser run catches fixture/tab-mount gaps node-env can't
